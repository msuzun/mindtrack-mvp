...
const styles = StyleSheet.create({
  ...
  title: { marginTop: 12, fontSize: 30, lineHeight: 38, fontWeight: '700', color: colors.text },
  subtitle: { marginTop: 4, color: colors.muted, fontSize: 14, lineHeight: 21 },
  summaryCard: {
  ...
  summaryLabel: { color: colors.muted, fontSize: 10, fontWeight: '700', letterSpacing: 1 },
  summaryValue: { color: colors.text, fontSize: 17, fontWeight: '700', marginTop: 5 },
  ...
  minutes: { marginTop: 9, color: colors.muted, fontSize: 12, lineHeight: 18 },
